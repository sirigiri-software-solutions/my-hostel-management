        ...
        <tbody className='bodystar'>
          {
            rows.map((item, index) => <tr>
              ...
              {item.image && <td data-label={t('mobileTable.image')} onClick={onClickTentantRow ? () => onClickTentantRow(item) : null}><img className='personImage' loading="lazy" src={item.image} alt='img' /></td>}
